                ...
                <li class="menu">
                    ...
                    <a class="dropdown-toggle" data-bs-toggle="collapse" data-bs-target="#dashboard" aria-controls="dashboard" aria-expanded="false">
                        <div style="color: black;">
                            ...
                            <span style="color: white; font-size: 20px;">{{ $t('Parametros') }}</span>
                        </div>
                        <div>
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                    ...
                    >
                        ...
                        <div style="color: black;">
                         ...
                         <span style="color: white; font-size: 20px;">{{ $t('Sair') }}</span>
                        </div>
...
<script setup>
    ...
    signOut(getAuth()).then(() => {
     router.push("/")
      ...
      console.log(storeUser.user.photoUrlOri)
    })
    }   
